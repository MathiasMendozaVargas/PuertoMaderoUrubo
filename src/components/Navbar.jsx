...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#001540] shadow-lg fixed w-full z-50 font-body">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            ...
            >
              <img
                className="block h-8 sm:h-10 w-auto rounded-full"
                src="/Sources/logo.jpg"
                alt="Logo"
              />
              <span className="ml-2 text-white text-lg font-bold sm:text-xl">
                Puerto Madero Urubó
              </span>
            </a>
          </div>
          ...
          <div className="hidden lg:flex sm:items-center sm:ml-6">
            <div className="flex space-x-4">
              <a
                href="#Promoción"
                className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm sm:text-base font-medium"
              >
                Promoción
              </a>
              <a
